...
\begin{axis}[x=3cm,y=3cm,z=0cm, xtick={-1,-.5,...,1},
title={$x^3+y^3=K \approx 0$},
small,
view={0}{90},
enlarge x limits,
domain=-1:1,
...
\fill [white] (axis cs:-1,-1) rectangle (rel axis cs:1,1);

\addplot3[domain=-1.1:1.1,
domain y=-1:1,
    color=blue!30!white,
    quiver={
        u={(\X)/\length},
...
\addplot3[thick,contour gnuplot={levels={.5,.01,-.2,-.5}}]
{x^3+y^3};
\end{axis}
\end{tikzpicture}
